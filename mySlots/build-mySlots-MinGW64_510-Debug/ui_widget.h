...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        label->setGeometry(QRect(150, 100, 61, 31));
    ...
    {
        Widget->setWindowTitle(QApplication::translate("Widget", "\346\210\221\346\230\257\344\270\273\347\252\227\345\217\243", 0));
